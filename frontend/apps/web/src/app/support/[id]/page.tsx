      ...
      <div className="max-w-[900px] mx-auto relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs text-text-secondary">
            <Link
              href="/dashboard"
              className="flex items-center gap-1.5 py-2 hover:text-text-primary transition-colors"
            >
            ...
            <Link
              href="/support"
              className="hover:text-text-primary transition-colors flex items-center gap-1.5 py-2"
            >
          ...
          <Link
            href="/support"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 min-h-[44px] rounded-xl text-xs font-semibold text-text-secondary hover:text-text-primary hover:bg-white/5 border border-white/10 transition-colors"
          >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                {ticket.status !== 'CLOSED' && (
                  <Button
                    ...
                    size="sm"
                    onClick={handleClose}
                    className="self-start sm:self-center shrink-0 min-h-[44px]"
                  >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3 mb-1.5">
                      <span className="text-10 font-bold text-text-primary uppercase tracking-wide truncate">
                        {isUser ? adminName : 'Support Team'}
                      </span>
                      <span className="text-10 text-text-secondary shrink-0">
